...
namespace HashtagChampion
{
    public class PlayerTest : NetworkBehaviour
    {
        ...
        private List<PlayerTest> playersInRange = new List<PlayerTest>();
        ...
        public static PlayerTest localPlayerController;
        public static List<PlayerTest> allPlayers = new List<PlayerTest>();
        ...
        {
           //displayName = "newName";
            displayNameNumber = Random.Range(1,10);
            //Rpc_SetName(newName);
        }*/

        [Command]
        private void Cmd_ObeyMe(/*string newName*/)
        {
            Debug.Log("Cmd_ObeyMe");
            //displayName = "newName";
            int newNum = displayNameNumber;
            while (newNum == displayNameNumber)
            {
                newNum = Random.Range(1, 10);
            }
            displayNameNumber = newNum;
            //Rpc_SetName(newName);
        }
        /*[Client]
        ...
        [Server]
        private void Push(PlayerTest pushed, Vector3 pushForce, float freezeDuration)
        {
        ...
        private IEnumerator TagCoroutine()
        {
            ...
            while (Time.time < endTime)
            {
                ...
                {
                    PlayerTest nextTagger = null; // = serverData.playersInRange[0];
                    ...
                    else
                    {
                        ...
                        {
                            PlayerTest player = playersInRange[i];
        ...
        private void DetectPlayersInTagBounds()
        {
            ...
            {
                PlayerTest otherPlayer = allPlayers[i];
        ...
        private void Update()
        {
            ...
            if (localPlayerController == this)
            {
                ...
                {
                    //Cmd_SetName(/*"What's wrong with SyncVar?!"*/);
                    Cmd_ObeyMe();
                }
                #endregion
            }
        ...
        [Server]
        public static void AddPlayer(PlayerTest player)
        {
            allPlayers.Add(player);
        }

        [Server]
        public static void RemovePlayer(PlayerTest player)
        {
